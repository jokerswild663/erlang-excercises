...
find_max([Head | City_List]) -> find_max(City_List, Head).

find_max([],City) -> City;
find_max([{City_Name, {c,Current_temp}} | City_List], {Name, {c,Max_temp_so_far}}) ->
if
  Current_temp > Max_temp_so_far ->
    find_max(City_List, {City_Name, {c,Current_temp}});

  Current_temp =< Max_temp_so_far -> 
    find_max(City_List, {Name, {c, Max_temp_so_far}})
end.
